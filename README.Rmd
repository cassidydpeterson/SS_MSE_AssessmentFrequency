...
setwd("~/Github/SS_MSE_AssessmentFrequency")

```


```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
load("Results\\Results_Base_Concept.RData")
load("Results\\Results_Base_HiMexRec.RData")
load("Results\\Results_Base_LoMexRec.RData")
...
```{r echo=TRUE, fig.height=5, fig.width=9, warning=TRUE, paged.print=TRUE}
