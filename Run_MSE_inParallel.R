...
OMdir = "R:\\Management Strategy Evaluation\\SB\\MSE_RUN\\OM_BH\\FRQ1\\OM" # OM directory
EMdir = "R:\\Management Strategy Evaluation\\SB\\MSE_RUN\\OM_BH\\FRQ1\\EM" # EM directory
StoreResults = "R:\\Management Strategy Evaluation\\SB\\MSE_RUN\\TEST_Base\\FRQ1\\StoreResults" # Directory to store results
...
foreach(h=names(list.frq)) %dopar% {
  ...
  MSE_func(MCMCdir, OMdir=list.frq[[h]]$OMdir, EMdir=list.frq[[h]]$EMdir, 
