...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn #  parm_name
             3            10       6.27017       6.27017             1             0          1          0          0          0          0          0          0          0 # SR_LN(R0)
           0.2           0.7           0.3          0.29           0.005             0         2          0          0          0          0          0          0          0 # SR_BH_steep
            ...
            -1		   1	      0.870581         0	  0.13		   0	      -2	 0	    0	       0	  0	     0	        0	   0 # SR_autocorr 0.671116, SD=0.130654
#
#3 #_SR_function: 2=Ricker; 3=std_B-H; 4=SCAA; 5=Hockey; 6=B-H_flattop; 7=survival_3Parm; 8=Shepard_3Parm
#0  # 0/1 to use steepness in initial equ recruitment calculation
#0  #  future feature:  0/1 to make realized sigmaR a function of SR curvature
...
# 0.2543 #_max_bias_adj_in_MPD (-1 to override ramp and set biasadj=1.0 for all estimated recdevs)
 1970.050 #_last_early_yr_nobias_adj_in_MPD                   
 1990.623 #_first_yr_fullbias_adj_in_MPD                      
 2011.292 #_last_yr_fullbias_adj_in_MPD                       
 2015.806 #_first_recent_yr_nobias_adj_in_MPD                 
  -1 #  0.000 #_max_bias_adj_in_MPD (1.0 to mimic pre-2009 models)
...
#
#_Q_setup											
#	float=1	means	calculated	analytically;	no	float	(float=0)	means	parameter	is	estimated
...
-15	15	-7.3707	-7.3707	0.1	6	1	0	4	1960	2115	2	0	0	#	LnQ_base_S1_LPS(5)																																											
-15	15	-6.67915 -6.67915 0.1	6	1	0	4	1960	2115	2	0	0	#	LnQ_base_S5_NMFS_LLSE(9)																																											
...
100	200	149.803	149.803	5	6	3	0	4	1960	2115	6	0	0	#SizeSel_P1_F1_COM_GOM(1)
-15	15	-10	-10	0	0	-3	0	0	0	0	0	0	0	#SizeSel_P2_F1_COM_GOM(1)
0	10	5.44511	5.44511	0.2	6	3	0	4	1960	2115	6	0	0	#SizeSel_P3_F1_COM_GOM(1)
0	10	5.59834	5.59834	0.2	6	3	0	4	1960	2115	6	0	0	#SizeSel_P4_F1_COM_GOM(1)
...
-1	1	0.732265	0.732265	50	0	4	0	0	0	0	0	0	0	#SzSel_Male_Ascend_F1_COM_GOM(1)
...
0	1	0.672358	0.672358	0.05	6	5	0	0	0	0	0	0	0	#SzSel_Male_Scale_F1_COM_GOM(1)
# 2   F2_COM_SA LenSelex		F2_COM_SA	F2_COM_SA											
50	150	92.4207	92.4207	0.5	6	2	0	4	1960	2115	6	0	0	#SizeSel_P1_F2_COM_SA(2)
1	100	27.3304	27.3304	1	6	3	0	4	1960	2115	6	0	0	#SizeSel_P2_F2_COM_SA(2)
# 3   F3_RecMEX LenSelex		F3_RecMEX	F3_RecMEX											
1	100	55.1685	55.1685	5	6	2	0	4	1960	2115	6	0	0	#SizeSel_P1_F3_RecMEX(3)
-15	-5	-9.99666	-9.99666	1	6	-3	0	0	0	0	0	0	0	#SizeSel_P2_F3_RecMEX(3)
...
# 4   F4_MEN_DSC LenSelex		F4_MEN_DSC	F4_MEN_DSC											
...
# 5   S1_LPS LenSelex		S1_LPS	S1_LPS											
100	200	155.057	155.057	5	6	3	0	4	1960	2115	6	0	0	#SizeSel_P1_S1_LPS(5)
-15	15	-10	-10	0	0	-3	0	0	0	0	0	0	0	#SizeSel_P2_S1_LPS(5)
0	10	7.31809	7.31809	0.2	6	3	0	4	1960	2115	6	0	0	#SizeSel_P3_S1_LPS(5)
0	30	14.7724	14.7724	1	6	3	0	4	1960	2115	6	0	0	#SizeSel_P4_S1_LPS(5)
-999	-999	-999	-999	0	0	-3	0	0	0	0	0	0	0	#SizeSel_P5_S1_LPS(5)
-999	-999	-999	-999	0	0	-3	0	0	0	0	0	0	0	#SizeSel_P6_S1_LPS(5)
# 6   S5_NMFS_LLSE LenSelex		S5_NMFS_LLSE	S5_NMFS_LLSE											
100	200	162.448	162.448	5	6	2	0	4	1960	2115	6	0	0	#SizeSel_P1_S5_NMFS_LLSE(9)
-15	15	-10	-10	0	0	-3	0	0	0	0	0	0	0	#SizeSel_P2_S5_NMFS_LLSE(9)
0	10	7.13	7.13	0.2	6	3	0	4	1960	2115	6	0	0	#SizeSel_P3_S5_NMFS_LLSE(9)
0	10	5.5709	5.5709	0.3	6	3	0	4	1960	2115	6	0	0	#SizeSel_P4_S5_NMFS_LLSE(9)
...
-10	10	-6.59721	-6.59721	1	6	4	0	0	0	0	0	0	0	#SzSel_Male_Peak_S5_NMFS_LLSE(9)
-5	5	-0.661188	-0.661188	0.1	6	4	0	0	0	0	0	0	0	#SzSel_Male_Ascend_S5_NMFS_LLSE(9)
-5	5	-0.779823	-0.779823	0.1	6	4	0	0	0	0	0	0	0	#SzSel_Male_Descend_S5_NMFS_LLSE(9)
-15	15	0	0	0	0	-4	0	0	0	0	0	0	0	#SzSel_Male_Final_S5_NMFS_LLSE(9)
0	1	0.730093	0.730093	0.05	6	5	0	0	0	0	0	0	0	#SzSel_Male_Scale_S5_NMFS_LLSE(9)
...
# #Factor Fleet New_Var_adj hash Old_Var_adj New_Francis    New_MI Francis_mult Francis_lo Francis_hi   MI_mult Type         Name
#       4     1    0.954354    #           1    0.954354  2.189400     0.954354   0.560356   2.822188  2.189400  len   F1_COM_GOM
#       4     2    1.236358    #           1    1.236358 11.528500     1.236358   0.639321   4.286454 11.528500  len    F2_COM_SA
#       4     3    1.009150    #           1    1.009150  1.252230     1.009150   0.622204   6.081951  1.252230  len    F3_RecMEX
#       4     5    0.974803    #           1    0.974803  0.461545     0.974803   0.940682        Inf  0.461545  len       S1_LPS
#      4     6    1.056919    #           1    1.056919  3.350440     1.056919   0.692395   3.477502  3.350440  len S5_NMFS_LLSE
