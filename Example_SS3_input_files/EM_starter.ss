...
0 # 3 # write parm values to ParmTrace.sso (0=no,1=good,active; 2=good,all; 3=every_iter,all_parms; 4=every,active)
...
2 # 3 # Number of datafiles to produce: 1st is input, 2nd is estimates, 3rd and higher are bootstrap
...
0.001 # ALK tolerance (example 0.0001)
